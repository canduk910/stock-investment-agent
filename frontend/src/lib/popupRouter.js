...
//
//   show_stock_report   → 'stock_report'  : StockReportView(args.ticker 로 fetchStockBundle)
//   show_macro_dashboard → 'macro_dashboard': RegimeGauge(fetchMacroRegime, 자체 조회·무캐시)
//   show_watchlist       → 'watchlist'     : WatchlistView(fetchWatchlist)
//   show_balance         → 'balance'       : BalancePanel(fetchBalance, 무파라미터·조회전용·무캐시)
